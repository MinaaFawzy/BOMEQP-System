      ...
      <div className="flex">
        ...
        >
          <div className="flex flex-col h-full max-h-screen overflow-visible">
            ...
            <div
              className={`flex-shrink-0 border-b animate-slide-down layout-section-bg ${sidebarCollapsed ? 'p-3' : 'p-4'
                }`}
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className={`p-1.5 rounded-lg text-white/70 sidebar-hover transition-all duration-200 hover:scale-110 ${sidebarCollapsed ? 'w-full flex justify-center' : ''
                      }`}
            ...
            <nav className={`flex-1 min-h-0 ${sidebarCollapsed ? 'p-2 overflow-visible' : 'p-4 overflow-y-auto custom-scrollbar'
              }`}
